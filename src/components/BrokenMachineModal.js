...
const BrokenMachineModal = props => (
  <div>
    <Modal
      isOpen={props.selectedBox === "brokenmachine" ? true : false}
      contentLabel="Information Box"
      closeTimeoutMS={200}
    >
      <a onClick={props.handleClearSelectedBox} href="#" className="close"/>
      <div>
        <h1 id="title">Arızalı Makina Bilgisi</h1>
        <table id="students">
          <tbody>
            <tr>{props.renderTableHeaderBrokenMachine()}</tr>
...
export default BrokenMachineModal;
